...
export const nl = {
  ...
  settings: {
    ...
    addresses: "Adressen",
    addressesHelp: "Zodat Attent bestellingen en bezorging meteen kan klaarzetten.",
    yourAddress: "Jouw adres",
    herAddress: "Bezorgadres (haar)",
  ...
  outsource: {
    ...
    prepTitle: "Attent heeft dit klaargezet",
    prepHelp: "Controleer de gegevens, open de site en rond af. Attent bestelt of betaalt nooit zelf.",
    openAt: "Openen bij {provider}",
    openGeneric: "Open de site",
    copyDetails: "Kopieer gegevens",
    copied: "Gekopieerd",
    noAddress: "Tip: vul jullie adres in onder Profiel, dan staat het de volgende keer meteen klaar.",
    confirmCta: "Markeer als geregeld",
    confirmHelp: "Er wordt niets geboekt, betaald of verstuurd voor je bevestigt. Dit legt alleen vast dat jij het hebt geregeld.",
